module PlaPIM::Helpers
  ...
  module Miscellaneous
    ...
    def subitems_below(parent_item)
      parent_item = item_named(parent_item) if parent_item.is_a? String
      #subitems = parent_item.children.select { |a| a[:kind] == 'article' }
      subitems = parent_item.children.sort_by { |a| a.identifier }
      #subitems.sort_by { |a| a.identifier }
    end
